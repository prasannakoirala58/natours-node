        ...
        var displayMap = function displayMap(locations) {
          ...
          locations.forEach(function (loc) {
            ...
            new mapboxgl.Marker({
              ...
              .addTo(map); // Add popup of location name while hovering over the marker in the map
                    ...
                    while (1) {
                      switch ((_context.prev = _context.next)) {
                        ...
                        case 7:
                          ...
                          document.querySelector('.btn--save-password').textContent =
                            'Save Password'; // Clearing the input fields of passwords after they have been updated
